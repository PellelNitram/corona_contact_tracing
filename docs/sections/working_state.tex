...
\begin{figure}[H]
    ...
    \caption{Second infection wave in figure~\ref{fig:multipleOutbreaks}. Blue: not infected, red: infected, green: recovered. $t = 190$ cluster gets infected (top left), $t = 200$ disease spreads (top right ), $t = 210$ most of the cluster is infected (bottom left) and $t = 270$ cluster recovers (bottom right).}%
